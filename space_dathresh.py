...
while elapsed_time < run_time:  # time units of years
    ...
    highslope2=np.where(slp2>max_slp)
    lowdrainage2=np.where(da2>80000)
    list2=list(set(highslope2[0]) & set(lowdrainage2[0]))
    
    highslope3=np.where(slp3>max_slp)
    lowdrainage3=np.where(da3>80000)
    list3=list(set(highslope3[0]) & set(lowdrainage3[0]))
    
    mg2.at_node["bedrock_erodibility"] = K_mid    
    mg2.at_node["bedrock_erodibility"][list2] = K_max


    mg3.at_node["bedrock_erodibility"] = K_mid
    mg3.at_node["bedrock_erodibility"][list3] = K_min
    
    mg2.at_node["sed_erodibility"] = Ks_mid
    mg2.at_node["sed_erodibility"][list2] = Ks_max


    mg3.at_node["sed_erodibility"]= Ks_mid
    mg3.at_node["sed_erodibility"][list3] = Ks_min
